/*Students data project with file stream by sushil Ghimire*/
#include<conio.h>
#include<process.h>
#include<stdio.h>
#include <iostream>
...
case 7: Trash(); break;
case 8:
cout<<"\nThank you for using database student project application:";
cout<<"\npress any key to exit";
getch();
exit(0);
default: cout<<"Wrong Input please enter the correct value....";
}
system("pause");//exe file reholder screen pause.
options();
cin>>ch;
}
}
...
void Delete()
{
  ...
  fstream fout("temp.dat",ios::out|ios::binary|ios::app);
